...
public class SingleChoiceActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initDataAndRecycler() {
        ...
        if (data != null) {
            ...
            mTitleContext.setText("桌号:" + SharedPreUtils.getString(this, "user_numberplate") + "      考生:" + SharedPreUtils.getString(this, "user_name") + "      第" + data.getTp_senum() + "题");
            ...
            String[] split = data.getTp_options().split("/");
